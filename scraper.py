...
def parse_notice(link, today):
    try:
        ...
        if response.status_code == 200:
            ...
            # Traigo el docuemnto html dela noticia.
            notice = response.content.decode('utf-8')
            parsed = html.fromstring(notice)


            #Quiero traer el título, el cuerpo y el resumen, hago una validación
            # try -except, estoy haciendolo para los índices dela lista.
            # Pueden haber noticias con nodos faltantes por lo que arrojará un error
            try:
                #Traemos el primer elemento dela lista.
                title = parsed.xpath(XPATH_LINK_TO_TITLE)[0]

                # No es deseable tener comillas en los títulos porque presentan un erroren OS.
                # Para solucionar esto, hacemos uso deque title es un str y del metodo replace()                title = title
            ...
            # de manera segura y así nose corrompe el archivo.
...
def parse_home():
    ...
    try:
        ...
        # Aqui va lalógica para traer los links.
        if response.status_code == 200:
            # .content trae  el HTML que necesita ser traducido con un decode para que python lo entienda
            # en terminos de caracteres, me devuelve un string queno es más que el HTML crudo.
            ...
            # Lalínea de código me arroja un array vacío. Pero en google si lo enseña.
            ...
            # en determinado formato que será guardado enla carpeta y con la función strftime logramos esto
